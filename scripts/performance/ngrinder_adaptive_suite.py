...
SCHEDULE = [
    # --- 본 테스트 전 웜업 ---
    (IDS["ADAPTIVE WARM-UP"], "적응형 락 초기 웜업", 5, "adaptive-lock", "warmup"),

    # --- 적응형 락 ---
    (IDS["ADAPTIVE WARM-UP"], "적응형 락 웜업", 3, "adaptive-lock", "warmup"),
    (IDS["ADAPTIVE 500"], "적응형 락 Vuser 500 테스트", 7, "adaptive-lock", 500),
    (IDS["ADAPTIVE WARM-UP"], "적응형 락 웜업", 3, "adaptive-lock", "warmup"),
    (IDS["ADAPTIVE 800"], "적응형 락 Vuser 800 테스트", 7, "adaptive-lock", 800),
    (IDS["ADAPTIVE WARM-UP"], "적응형 락 웜업", 3, "adaptive-lock", "warmup"),
    (IDS["ADAPTIVE 1000"], "적응형 락 Vuser 1000 테스트(마지막 테스트)", 1, "adaptive-lock", 1000)
]
